...
closedir($handle);
$make_board = '';
#if (!ini_get("safe_mode")) $make_board = '<a class="menu" href="makeboard.php">掲示板作成</a><br>'."\n<hr>\n";
...
<div class="menu">管理メニュー</div>
<hr>
<a class="menu" href="main.php">トップ</a><br>
<hr>
<?=$make_board?>
<a class="menu" href="cap.php">キャップ管理</a><br>
<hr>
<?php
$i = 0;
