...
?><HTML><HEAD><BASE href=<?=$url.'/test/r.php/'.$bbs?>/><meta http-equiv="Content-Type" content="text/html; charset=utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><TITLE><?=$bbs?> スレッド一覧</TITLE></HEAD><BODY><A href=../../p.php/<?=$bbs?>/<?=$mae?>>前</A> <A href=../../p.php/<?=$bbs?>/<?=$tugi?>>次</A><HR><?php
for ($i = $st; $i < $tugi; $i++) {
