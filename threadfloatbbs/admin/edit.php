...
if (isset($_REQUEST['file'])) {
	...
	else disperror("ERROR!", "ファイル名が不正です。");
	if (!is_file($file_name)) disperror("ERROR!", "ファイル(".$file_name.")がありません。ファイルをアップロードしてください。");
	if (!is_writable($file_name)) disperror("ERROR!", "ファイル(".$file_name.")に書き込み属性がありません。パーミッションを606か666にしてください。");
	$comment = '';
