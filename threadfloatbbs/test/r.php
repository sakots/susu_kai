...
if (!file_exists("../$bbs/dat/$key.dat")) {
	if (file_exists("../$bbs/kako/$key.html")) echo"過去ログ倉庫です。<BR>携帯では見られません。";
	else echo("スレッドが見つかりません。");
	exit;
}
...
?>
<html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title><?=$subject?></title></head><body><hr><?=$link?><a href=<?=$to+1?>->次</a> <a href=n>新10</a> <a href=1->1-</a> <a href=../../../../<?=$bbs?>/i/>板</a> <a href=w>ｶｷｺﾐ</a><hr><?php
...
echo $link;
?>
<a href=<?=$to+1?>->次</a> <a href=w>かきこみ</a><hr><?=$version?></body></html>