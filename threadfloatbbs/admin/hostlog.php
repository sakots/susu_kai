...
if (!is_dir("../$_GET[bbs]")) disperror("ERROR!", "そんな板orスレッドないです。");
#====================================================
#　初期情報の取得（設定ファイル）
#====================================================
#設定ファイルを読む
...
if (!is_file($log_file)) disperror("ERROR!","ERROR:$log_file がありません");
if (!is_writable($log_file)) disperror("ERROR!","ERROR:$log_file に書き込み属性がありません");
